...
import 'package:tenants_shield_project/pages/guest_page/controllers/general_info_page_controller.dart';
import '../../../appStyle/app_colors.dart';
import '../../../widgets/app_bar.dart';

// ignore: must_be_immutable
class GeneralInfoPageView extends StatelessWidget {
  late  bool connected=false;
   GeneralInfoPageView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<GeneralInfoPageController>(builder: (controller) {
      return Scaffold(
        backgroundColor: AppColors.whiteColor,
          resizeToAvoidBottomInset: false,
          appBar: appBar(controller.appContentModel.data!=null?controller.appContentModel.data!.appScreen![1].text!.label.toString():"",context),
          body: Builder(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                          children: [
                            ...
                            HtmlWidget(
                              controller.appContentModel.data!.appScreen![1].text!.text.toString(),
