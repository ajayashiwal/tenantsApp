...
class ContactInfoView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ContactInfoPageController>(builder: (controller) {
      return Scaffold(
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: Column(
                      children: [
                        (controller.profile!=null && controller.profile!=""?
                        ClipRRect(
                  ...
                  ):controller.website==""?Container():Padding(
                    padding: AppDimensions.margin0_20_20_0,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                  ...
                  controller.email==""?Container(): SizedBox(height: AppDimensions.ten),
                  controller.email==""?Container():Divider(color: Colors.grey.shade400),
                  controller.email==""?Container():SizedBox(height: AppDimensions.ten),
                  controller.email==""?Container():Padding(
                    padding: AppDimensions.margin0_20_20_0,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
