...
class LawyerViewAppStages extends StatelessWidget {
  late  bool connected=false;
  bool isSelected=false;
  LawyerViewAppStages({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<LawyerAllProjectStageController>(builder: (controller) {
      return Scaffold(
                ...
                if (controller.projectListModel != null)
                  if (controller.projectListModel!.data != null)
                    ListView.separated(
                        ...
                        itemCount:controller.projectListModel!.data!.stages!.length,
                        ...
                        itemBuilder:(context,i){
                          ...
                          return
                            Container(
                                color: controller.projectListModel!.data!.stages![i].status.toString()!="Finished"?(controller.projectListModel!.data!.stages![i].status=="Started"?AppColors.skyHighLightColor:Colors.transparent):const Color(0xFFE5F8E8),
                                child:  SizedBox(
                                  height: 170,
                                  child: Row(
                                    children: [
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Expanded(child: Row(
                                              ...
                                              children: [
                                                Text("${TenantsLocalizations.of(context)!.find(AppStrings.level)} ${i+1}",style:controller.projectListModel!.data!.stages![i].status=="Started"?AppThemeStyles.blueBold141:(controller.projectListModel!.data!.stages![i].status=="Finished"?AppThemeStyles.greenBold141:AppThemeStyles.greyBold141)),
                                              ],
                                            )),
                                            Text(DateFormat("dd.MM.yyyy").format(DateTime.parse(controller.projectListModel!.data!.stages![i].endDate)),style: AppThemeStyles.greyLight10),
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children:  [
                                                VerticalDivider(
                                                  thickness: 2,
                                                  color: controller.projectListModel!.data!.stages![i].status=="Started"?AppColors.blueColor:(controller.projectListModel!.data!.stages![i].status=="Finished"?AppColors.lightGreenColor:Colors.grey),
                                                ),
                                              ],
                                            ),
                                            Column(
                                                    ...
                                                    Stack(
                                                      children: [
                                                        controller.projectListModel!.data!.stages![i].status.toString()=="Started"? Container(
                                                            ...
                                                            )):(controller.projectListModel!.data!.stages![i].status.toString()=="Finished"?Container(
                                                            decoration: BoxDecoration(
                                                                color: AppColors.whiteColor,
                                                                borderRadius: BorderRadius.circular(AppDimensions.fifty),
                                                            ...
                                                            child: Padding(
                                                              padding: AppDimensions.padding10,
                                                              // ignore: unnecessary_null_comparison
                                                              child: controller.projectListModel!.data!.stages![i].stage!.image.toString()==null?Image.asset("assets/images/app_icon1.png",height: AppDimensions.thirty,width: AppDimensions.thirty):
                                                              fileName=="svg"? SizedBox(
                                                                height: AppDimensions.thirty,width: AppDimensions.thirty,
                                                                child: SvgPicture.network(
                                                                  controller.projectListModel!.data!.stages![i].stage!.image.toString(),
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(controller.projectListModel!.data!.stages![i].stage!.name.toString(),style: AppThemeStyles.blue16),
                                            SizedBox(height: AppDimensions.five),
                                            Text("${DateFormat("dd.MM.yyyy").format(DateTime.parse(controller.projectListModel!.data!.stages![i].endDate))} - ${DateFormat("dd.MM.yyyy").format(DateTime.parse(controller.projectListModel!.data!.stages![i].startDate))}",style: AppThemeStyles.greyLight10),
                                            SizedBox(height: AppDimensions.five),
                                            Text("${controller.projectListModel!.data!.stages![i].stage!.responsibility.toString()} : ${TenantsLocalizations.of(context)!.find("responsibility")}",style: AppThemeStyles.black14),
                                            SizedBox(height: AppDimensions.ten),
                                            controller.projectListModel!.data!.stages![i].stage!.description.toString()!="null"?Expanded(
                                              child: HtmlWidget(
                                                controller.projectListModel!.data!.stages![i].stage!.description.toString(),
